...
export default function GaleriaScreen() {
  ...
  return (
    <View style={styles.container}>
      <Button title="BUSCAR IMAGEN EN GALERIA" onPress={pickImage} color={"black"}/>
      <Image source={{ uri: image }} style={styles.image} />
      <Button title={uploading ? 'Subiendo...' : 'Subir Imagen'} disabled={uploading} onPress={uploadImage} color={"blue"} />
    </View>
  );
}
